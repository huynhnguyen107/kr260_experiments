...
//Date        : Wed May 13 20:59:59 2026
//Host        : LAPTOP-CHCSI1R5 running 64-bit major release  (build 9200)
//Command     : generate_target axi_dma_loop_back.bd
//Design      : axi_dma_loop_back
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "axi_dma_loop_back,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axi_dma_loop_back,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=5,da_board_cnt=1,da_clkrst_cnt=2,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axi_dma_loop_back.hwdef" *) 
module axi_dma_loop_back
   ();
  ...
  axi_dma_loop_back_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  axi_dma_loop_back_axi_dma_0_0 axi_dma_0
  ...
  axi_dma_loop_back_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  axi_dma_loop_back_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  axi_dma_loop_back_smartconnect_0_0 smartconnect_0
  ...
  axi_dma_loop_back_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0

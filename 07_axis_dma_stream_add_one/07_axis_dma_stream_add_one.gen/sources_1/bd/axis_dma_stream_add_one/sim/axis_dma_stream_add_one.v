...
//Date        : Thu May 14 16:18:42 2026
//Host        : LAPTOP-CHCSI1R5 running 64-bit major release  (build 9200)
//Command     : generate_target axis_dma_stream_add_one.bd
//Design      : axis_dma_stream_add_one
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "axis_dma_stream_add_one,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axis_dma_stream_add_one,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=1,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axis_dma_stream_add_one.hwdef" *) 
module axis_dma_stream_add_one
   ();
  ...
  axis_dma_stream_add_one_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  axis_dma_stream_add_one_axi_dma_0_0 axi_dma_0
  ...
  axis_dma_stream_add_one_axis_add_one_0_0 axis_add_one_0
  ...
  axis_dma_stream_add_one_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  axis_dma_stream_add_one_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  axis_dma_stream_add_one_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  axis_dma_stream_add_one_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0

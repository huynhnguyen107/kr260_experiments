...
//Date        : Thu Jun 18 11:57:40 2026
//Host        : LAPTOP-CHCSI1R5 running 64-bit major release  (build 9200)
//Command     : generate_target cdc_asyn_fifo_axis.bd
//Design      : cdc_asyn_fifo_axis
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "cdc_asyn_fifo_axis,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cdc_asyn_fifo_axis,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "cdc_asyn_fifo_axis.hwdef" *) 
module cdc_asyn_fifo_axis
   ();
  ...
  wire [31:0]axis_add_one_0_m_axis_TDATA;
  wire [3:0]axis_add_one_0_m_axis_TKEEP;
  wire axis_add_one_0_m_axis_TLAST;
  wire axis_add_one_0_m_axis_TREADY;
  wire axis_add_one_0_m_axis_TVALID;
  ...
  cdc_asyn_fifo_axis_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  cdc_asyn_fifo_axis_axi_dma_0_0 axi_dma_0
  ...
  cdc_asyn_fifo_axis_axis_add_one_0_0 axis_add_one_0
       (.aclk(clk_wiz_0_clk_out1),
        .aresetn(proc_sys_reset_1_peripheral_aresetn),
        .m_axis_tdata(axis_add_one_0_m_axis_TDATA),
        .m_axis_tkeep(axis_add_one_0_m_axis_TKEEP),
        .m_axis_tlast(axis_add_one_0_m_axis_TLAST),
        .m_axis_tready(axis_add_one_0_m_axis_TREADY),
        .m_axis_tvalid(axis_add_one_0_m_axis_TVALID),
  ...
  cdc_asyn_fifo_axis_axis_data_fifo_0_0 axis_data_fifo_0
  ...
  cdc_asyn_fifo_axis_axis_data_fifo_0_1 axis_data_fifo_1
       (.m_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_tdata(axis_add_one_0_m_axis_TDATA),
        .s_axis_tkeep(axis_add_one_0_m_axis_TKEEP),
        .s_axis_tlast(axis_add_one_0_m_axis_TLAST),
        .s_axis_tready(axis_add_one_0_m_axis_TREADY),
        .s_axis_tvalid(axis_add_one_0_m_axis_TVALID));
  cdc_asyn_fifo_axis_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  cdc_asyn_fifo_axis_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(zynq_ultra_ps_e_0_pl_clk0),
        .clk_out1(clk_wiz_0_clk_out1),
        .locked(clk_wiz_0_locked),
        .reset(proc_sys_reset_0_peripheral_reset));
  cdc_asyn_fifo_axis_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  cdc_asyn_fifo_axis_proc_sys_reset_1_0 proc_sys_reset_1
       (.aux_reset_in(1'b1),
  ...
  cdc_asyn_fifo_axis_smartconnect_0_0 smartconnect_0
  ...
  cdc_asyn_fifo_axis_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0

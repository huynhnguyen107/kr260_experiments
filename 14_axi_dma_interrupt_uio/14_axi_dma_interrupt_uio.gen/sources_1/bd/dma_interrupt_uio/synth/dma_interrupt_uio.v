...
//Date        : Fri Jun 19 13:43:07 2026
//Host        : LAPTOP-CHCSI1R5 running 64-bit major release  (build 9200)
//Command     : generate_target dma_interrupt_uio.bd
//Design      : dma_interrupt_uio
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "dma_interrupt_uio,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dma_interrupt_uio,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "dma_interrupt_uio.hwdef" *) 
module dma_interrupt_uio
   ();
  ...
  dma_interrupt_uio_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  dma_interrupt_uio_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(axis_add_one_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep(axis_add_one_0_m_axis_TKEEP),
        .s_axis_s2mm_tlast(axis_add_one_0_m_axis_TLAST),
        .s_axis_s2mm_tready(axis_add_one_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(axis_add_one_0_m_axis_TVALID));
  dma_interrupt_uio_axis_add_one_0_0 axis_add_one_0
  ...
  dma_interrupt_uio_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  dma_interrupt_uio_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  dma_interrupt_uio_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  dma_interrupt_uio_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0

...
//Date        : Thu May 21 16:56:37 2026
//Host        : LAPTOP-CHCSI1R5 running 64-bit major release  (build 9200)
//Command     : generate_target dma_config_fir.bd
//Design      : dma_config_fir
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "dma_config_fir,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dma_config_fir,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "dma_config_fir.hwdef" *) 
module dma_config_fir
   ();
  ...
  wire [31:0]axis_fir4_configurab_0_m_axis_TDATA;
  wire [3:0]axis_fir4_configurab_0_m_axis_TKEEP;
  wire axis_fir4_configurab_0_m_axis_TLAST;
  wire axis_fir4_configurab_0_m_axis_TREADY;
  wire axis_fir4_configurab_0_m_axis_TVALID;
  ...
  dma_config_fir_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  dma_config_fir_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(axis_fir4_configurab_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep(axis_fir4_configurab_0_m_axis_TKEEP),
        .s_axis_s2mm_tlast(axis_fir4_configurab_0_m_axis_TLAST),
        .s_axis_s2mm_tready(axis_fir4_configurab_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(axis_fir4_configurab_0_m_axis_TVALID));
  dma_config_fir_axi_gpio_0_0 axi_gpio_0
  ...
  dma_config_fir_axis_fir4_configurab_0_0 axis_fir4_configurab_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk1),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .coeff_pack(axi_gpio_0_gpio_io_o),
        .ctr(axi_gpio_0_gpio2_io_o),
        .m_axis_tdata(axis_fir4_configurab_0_m_axis_TDATA),
        .m_axis_tkeep(axis_fir4_configurab_0_m_axis_TKEEP),
        .m_axis_tlast(axis_fir4_configurab_0_m_axis_TLAST),
        .m_axis_tready(axis_fir4_configurab_0_m_axis_TREADY),
        .m_axis_tvalid(axis_fir4_configurab_0_m_axis_TVALID),
        .s_axis_tdata(axi_dma_0_M_AXIS_MM2S_TDATA),
        .s_axis_tkeep(axi_dma_0_M_AXIS_MM2S_TKEEP),
        .s_axis_tlast(axi_dma_0_M_AXIS_MM2S_TLAST),
        .s_axis_tready(axi_dma_0_M_AXIS_MM2S_TREADY),
        .s_axis_tvalid(axi_dma_0_M_AXIS_MM2S_TVALID));
  dma_config_fir_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  dma_config_fir_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  dma_config_fir_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk1),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  dma_config_fir_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
